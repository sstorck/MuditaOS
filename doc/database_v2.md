...
| QUEUED | 0x10 | Defines message that is scheduled for sendin |
...
| lock_tim | (m) | INTEGER | time of inactivity of the user after which phone will be automatically blocked. Expressed in milliseconds. Default value is 30 000ms |
...
#### 18. Settings table - newer approach
