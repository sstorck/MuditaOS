...
Currently all the wording used in MuditaOS interface is collected in the form of JSON files which are located in [the image/system_a/data/lang folder](../image/system_a/data/lang/).
...
Keyboard input language files have JSON extension and are located in [the image/system_a/data/profiles folder](../image/system_a/data/profiles/).
