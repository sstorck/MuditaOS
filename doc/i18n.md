...
### Display language
Currently all the wording used in MuditaOS interface is collected in the form of JSON files which are located in [the image/system_a/assets/lang folder](../image/system_a/assets/lang/).
...
Keyboard input language files have JSON extension and are located in [the image/system_a/assets/profiles folder](../image/system_a/assets/profiles/).
